      ...
      <div className="connect">
        ...
        <div className="connect-form">
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="hname">
              <h5>Message</h5>
              <textarea name="message" placeholder="Tell me about your project or inquiry" rows="5" required />
            </div>
        ...
        <div className="connect-direct">
          ...
          <div className="pbox">
            <div className="impicon"><IoIosMail /></div>
          ...
          <div className="pbox">
            <div className="impicon"><IoCallOutline /></div>
          ...
          <div className="pbox">
            <div className="impicon"><SlCalender /></div>
            <div className="info">
              <h5>Availability</h5>
